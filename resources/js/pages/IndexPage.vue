<template>
  <div>
    ...
    <p>
      The Lycee Trading Card game has been rebooted since the end of 2016 with the new name: Lycee
      Overture.
    </p>
    <p>
    ...
    <p>
      ...
      description texts with the help of pattern matching in Japanese sentences. This is still in
      progress.
    </p>
