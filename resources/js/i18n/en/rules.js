export default {
  ...
  rowsAndColumns: {
    title: 'Orders and Columns',
    description: 'A spot a character fills is known as a Field.',
    point1_line1: 'Based on the image above, the horizontal formation make up an "Order" or "Row", while the verticle formation make up a "Column".',
    point1_line2: 'For example, "Ruler / Jeanne d\'Arc" (at the top right of the board) is on the right Column of the AF Order.',
    point1_line3: '(Your opponent will see her on the left Column of the AF Order.)',
  ...
  howToSummon: {
    ...
    description: 'A cost of [flower][flower] is required to summon this character.',
